        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-700">
              Checking the box below confirms that the student's parent/guardian
              agrees to the submission of this application. *
            </p>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg">
            <h3 className="font-semibold mb-2">Financial Aid Information</h3>
            <p className="text-sm text-gray-700 mb-2">
              School fees support faculty and staff salaries, room and board for
              students, and every aspect of running our boarding school. Limited
              financial aid is available for high achieving students with
              clearly documented financial need. If you are applying for
            ...
            <p className="text-sm text-gray-700 font-amharic">
              ...
              ትምህርት ቤታችንን ለማስኬድ የሚያስፈልጉ ሁሉንም ነገሮች ይደግፋሉ። ለከፍተኛ ተሳትፎ ላላቸው እና በግልጽ
              የተመዘገበ የገንዘብ ፍላጎት ላላቸው ተማሪዎች የተወሰነ የገንዘብ እርዳታ ይገኛል።
            </p>
          </div>
