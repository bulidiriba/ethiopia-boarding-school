        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-4">
              <Link
                href="https://web.facebook.com/fdremoe/?_rdc=1&_rdr#"
                target="_blank"
              ...
              <Link
                href="https://www.youtube.com/@fdreministryofeducationeth8699"
                target="_blank"
              ...
              <Link
                href="https://www.linkedin.com/company/ministry-of-education-ethiopia"
                target="_blank"
